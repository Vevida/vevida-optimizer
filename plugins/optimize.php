...
function vevida_optimize_db_tables() {
    ?>
        <div class="wrap">
            ...
            <p><?php _e( 'Keeping your WordPress database optimized is <em>a must</em> for a fast performing WordPress website. We at ','vevida-optimizer' ); ?>
			<a href="https://vevida.com" title="WordPress hosting made easy by Vevida">
			<?php _e( 'Vevida', 'vevida-optimizer' ); ?>
			</a>
			<?php _e( 'care about your site\'s performance.', 'vevida-optimizer' ); ?></p>
            <p><?php _e( 'Every WordPress post, draft, revision and comment adds data to your MySQL database, and removing revisions, drafts and comments creates empty space between data. This makes your database huger and fragmented. Defragmenting the data puts all data back in order, removing empty spaces and results in a smaller database. The defragmented database performs faster because MySQL will be able locate information much faster. ', 'vevida-optimizer' ); ?>
